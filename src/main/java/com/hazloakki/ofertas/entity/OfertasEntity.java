...
public class OfertasEntity {
	...
	public static OfertasEntity from(OfertasDto cuentaDto) {

		OfertasEntity cuentaEntity = new OfertasEntity();
	...
	public OfertasDto to() {
		...
		OfertasDto cuentaDto = new OfertasDto();
